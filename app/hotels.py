...
def get_hotels(
    ...
    page: int | None = Query(default=None, description="Номер страницы с отелями", gt=1),
    per_page: int | None = Query(default=None, description="Количество отелей на одной странице", gt=1, lt=30),
) -> list[Hotel]:
    hotels_ = []
    for hotel in hotels:
